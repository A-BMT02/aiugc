...
// Upload base64 image (for when user pastes or drops image)
...
export async function uploadAudioToSupabase(audioUrl) {
  try {
    ...
    // Fetch the audio from your backend
...
// NEW: Upload image to Supabase (for avatars/products from server)
...
// NEW: Upload reference video to Supabase
