...
export const MagicEditResultScene: React.FC = () => {
  ...
  const cursorY = interpolate(cursorProgress, [0, 1], [-100, 0]);
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#000000', opacity: fadeIn }}>
      {/* Success sound - Edit complete! (60fps timing) */}
      <Sequence from={20}>
      ...
      <div style={{ display: 'flex', height: '100%', color: 'white' }}>
        ...
        <div style={{ width: '450px', background: '#111111', borderRight: '1px solid rgba(255,255,255,0.1)', padding: '32px', display: 'flex', flexDirection: 'column', gap: '20px', overflowY: 'auto' }}>
          ...
          {/* Selected Avatar with Edited Badge */}
          <div>
            ...
            <div style={{ padding: '16px', background: 'rgba(34, 197, 94, 0.1)', border: '1px solid rgba(34, 197, 94, 0.3)', borderRadius: '10px', display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '48px', height: '64px', borderRadius: '6px', overflow: 'hidden', background: '#2a2a2a', position: 'relative' }}>
                <Img src={editedImageUrl} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                <div style={{ position: 'absolute', top: '2px', right: '2px', background: '#22c55e', borderRadius: '3px', padding: '1px 3px', fontSize: '8px' }}>✨</div>
              </div>
              <div><div style={{ fontSize: '14px', fontWeight: 600 }}>Alex</div><div style={{ fontSize: '12px', color: '#22c55e', marginTop: '2px' }}>✓ Edited</div></div>
            </div>
          </div>

          {/* Success Message */}
          <div style={{ padding: '20px', background: 'rgba(34, 197, 94, 0.1)', border: '1px solid rgba(34, 197, 94, 0.3)', borderRadius: '12px', textAlign: 'center' }}>
            <div style={{ fontSize: '32px', marginBottom: '8px' }}>✅</div>
            <div style={{ fontSize: '16px', fontWeight: 600, marginBottom: '4px' }}>Edit Complete!</div>
            <div style={{ fontSize: '12px', color: '#9ca3af' }}>Avatar now holding a book</div>
          </div>
          ...
          <div>
            ...
            <div style={{ padding: '16px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', minHeight: '90px', fontSize: '14px', color: '#6b7280' }}>Write your script here...</div>
          </div>
        ...
        <div style={{ flex: 1, background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px' }}>
          <div style={{ width: '400px', height: '711px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 20px 60px rgba(34, 197, 94, 0.3)', overflow: 'hidden', background: '#2a2a2a', position: 'relative' }}>
            <Img src={editedImageUrl} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ position: 'absolute', top: '16px', right: '16px', background: '#22c55e', backdropFilter: 'blur(8px)', padding: '8px 12px', borderRadius: '10px', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', fontWeight: 600 }}><span style={{ fontSize: '16px' }}>✨</span>Edited</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
