...
import { Play, Sparkles, Zap, Globe, Users, Wand2, Video, ArrowRight, Check, Loader2 } from 'lucide-react'
...
export default function Home() {
  ...
  const handleSubscribe = async (planName: string, priceId: string) => {
    ...
    try {
      ...
      // Use the URL from the response instead of redirectToCheckout
      if (data.url) {
  ...
  <img src="/blobbi-logo.png" alt="Blobbi Logo" className="h-12 md:h-16 object-contain" />
</div>

          {/* <div className="text-2xl font-black tracking-tighter">
            UGC<span className="text-green-400">AI</span>
          </div> */}
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#demo" className="text-sm hover:text-green-400 transition">Demo</a>
          </div>

          <div className="flex items-center gap-4">
            {user ? (
              <Link href="/create" className="px-5 py-2 bg-gradient-to-r from-green-500 to-green-600 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-green-500/50 transition-all">
                Dashboard
              </Link>
            ) : (
              <>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center pt-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="aspect-[9/16] bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-white/10 hover:border-green-500/50 transition-all hover:scale-105 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto mt-20 pt-20 border-t border-white/10">
            ...
            <div>
              <div className="text-4xl font-black text-green-400 mb-2">2.5min</div>
              <div className="text-sm text-gray-400">Avg Generation Time</div>
            </div>
            <div>
              <div className="text-4xl font-black text-green-400 mb-2">$1M+</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-black tracking-tighter mb-6">
              ...
              <span className="text-green-400">Simple to Use.</span>
            </h2>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                ...
                <div><a href="#demo" className="hover:text-green-400 transition">Demo</a></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div><a href="#" className="hover:text-green-400 transition">About</a></div>
                <div><a href="#" className="hover:text-green-400 transition">Blog</a></div>
                <div><a href="#" className="hover:text-green-400 transition">Careers</a></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div><a href="#" className="hover:text-green-400 transition">Privacy</a></div>
                <div><a href="#" className="hover:text-green-400 transition">Terms</a></div>
                <div><a href="#" className="hover:text-green-400 transition">Contact</a></div>
              </div>
            </div>
          </div>
