...
const ACTOR_IMAGES = [
  ...
  { name: 'Michael',  url: `${SUPABASE}/avatars/Michael_Caucasian_Old_Male.png` },
  { name: 'Emily',    url: `${SUPABASE}/avatars/Emily_Asian_Old_Female.png` },
  { name: 'Linda',    url: `${SUPABASE}/avatars/Linda_Caucasian_Old_Female.png` },
  { name: 'Kayla',    url: `${SUPABASE}/avatars/Kayla_Black_Old_Female.png` },
  { name: 'John',     url: `${SUPABASE}/avatars/John_Black_Old_Male.png` },
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center pt-24">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-full mb-8">
            ...
            <span className="text-sm text-green-400 font-medium">Pay As You Go — No Subscription</span>
          </div>
          ...
          <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3 mb-8">
            {ACTOR_IMAGES.map((actor) => (
              <div key={actor.name} className="group relative">
                <div className="aspect-[9/16] rounded-2xl overflow-hidden border border-white/10 group-hover:border-green-500/50 transition-all group-hover:scale-105">
                  <img
                    src={actor.url}
                    alt={actor.name}
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-green-500/20 to-green-600/10 border border-green-500/40 rounded-3xl p-12 md:p-16 text-center">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-xl mx-auto">
              Buy credits once, use them whenever. No subscriptions, no monthly fees.
            </p>
            <Link
              href="#pricing"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-green-500/50 transition-all"
            >
